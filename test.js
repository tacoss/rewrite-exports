...
const expected = `
  ...
  let a=module.exports.a=void 0;let b=module.exports.b=void 0;let c=module.exports.c=0;
...
function main() {
  ...
  expect(rExports('export let  1   =    broken();')).toEqual('let  1   =module.exports.1=    broken();');
  ...
  expect(rExports('export let other1 = other2 = otherN')).toEqual('let other1 =module.exports.other1=void 0;let  other2 =module.exports.other2= otherN');
  ...
  expect(rExports('export let  value, a,  b,    c       = 0;')).toEqual('let  value=module.exports.value=void 0;let  a=module.exports.a=void 0;let   b=module.exports.b=void 0;let     c       =module.exports.c= 0;');
